...
// import DocumentPicker from 'react-native-document-picker'; // Add this import
...
const AudioPlayer: FC<Props> = ({
  ...
  // Function to handle selecting and playing a local MP3 file
  // const pickLocalSong = async () => {
  //   try {
  //     const res = await DocumentPicker.pick({
  //       type: [DocumentPicker.types.audio],
  //     });

  //     const localUri = res[0]?.uri; // Get the URI of the first selected file
  //     if (localUri) {
  ...
  return (
    <AppModal animation visible={visible} onRequestClose={onRequestClose}>
      <View style={styles.container}>
        ...
        {/* Button to select and play a local song */}
        {/* <Button title="Pick Local Song" onPress={pickLocalSong} /> */}
      </View>
    </AppModal>
  );
};
